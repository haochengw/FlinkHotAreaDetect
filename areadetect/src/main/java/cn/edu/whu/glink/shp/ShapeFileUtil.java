...
public class ShapeFileUtil {
    ...
    public static void createShp(String file, String outputFolderPath, double rasterSize) throws IOException, ParseException, java.text.ParseException {
        ...
        String path = outputFolderPath + "\\"+ (int) (rasterSize*1000) +"m\\";
        new File(path).mkdirs();
        write2Shape( path + "result2.shp", "UTF-8", simpleFeatureType, list, data);
    }
}